...
Some possible correlation, maybe stronger at lag 2, lag 7 and lag 10.Possible spline effect. 
...
Very weak correlation, if any at all, but some possible spline effect after approx min.temp = 12. This is particularly true in no lag, lag 2, lag 7 and lag 10.
