...
Once I created the lagged variables, I could compare these against my outcome of interest. As I will be modelling `log(cases)`, I will use this against the different variables. 
...
```{r rain_vs_log_cases, fig.show='hold', out.width='20%', warning=FALSE, echo=FALSE, results='hide'}
...
```{r mean.temp_vs_log_cases, fig.show='hold', out.width='20%', warning=FALSE, echo=FALSE, results='hide'}
...
```{r min.temp_vs_log_cases, fig.show='hold', out.width='20%', warning=FALSE, echo=FALSE, results='hide'}
...
```{r max.temp_vs_log_cases, fig.show='hold', out.width='20%', warning=FALSE, echo=FALSE, results='hide'}

plot.list$max.temp

```

Some correlation, particularly at lag 7 and lag 10. Plot for lag 2 shows an interesting pocket where no data is found. 
